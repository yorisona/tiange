  ...
  <div>
    ...
    >
        ...
        <el-form :model="form" :rules="formRules" label-width="134px" ref="formRef">
          ...
          <el-form-item label="合同附件：" prop="attachment_url">
            ...
            <span class="upload-tips mgl-16">
              支持扩展名：.docx .doc .pdf .jpg .png .xlsx
              .xls；最多上传5个文件（单个文件大小不超过30M）
            </span>
      ...
      <template #footer>
        ...
        <tg-button type="primary" @click="onSaveBtnClick" :disabled="saveLoading">提交</tg-button>
      </template>
    </el-dialog>
