  ...
  <div class="finance-payment-page flex-auto">
    ...
    >
      <div class="main-header">
        ...
        <div class="header" :style="{ marginLeft: permission.payment_export ? '48px' : '16px' }">
          <div class="item">
      ...
      >
        ...
        <el-table-column className="ProjectInfoColumn" label="项目信息" width="178">
          <template slot-scope="scope">
        ...
        >
          <template slot-scope="scope">
            ...
            <div v-else>
              ...
              &lt;!&ndash;                v-if="permission.payment_upload_edit_invoice && scope.row.invoice_info.length < 1"&ndash;&gt;
              &lt;!&ndash;                type="text"&ndash;&gt;
              &lt;!&ndash;                class="button-item-padding"&ndash;&gt;
              &lt;!&ndash;                @click.native.stop="uploadBtnClick(scope.row)"&ndash;&gt;
              &lt;!&ndash;                >上传发票</el-button&ndash;&gt;
              &lt;!&ndash;              >&ndash;&gt;
              &lt;!&ndash;              <el-button&ndash;&gt;
              &lt;!&ndash;                v-else-if="&ndash;&gt;
              &lt;!&ndash;                  permission.payment_upload_edit_invoice && scope.row.invoice_info.length >= 1&ndash;&gt;
              &lt;!&ndash;                "&ndash;&gt;
              &lt;!&ndash;                type="text"&ndash;&gt;
              &lt;!&ndash;                class="button-item-padding"&ndash;&gt;
              &lt;!&ndash;                @click.native.stop="editBtnClick(scope.row)"&ndash;&gt;
              &lt;!&ndash;                >编辑发票</el-button&ndash;&gt;
              &lt;!&ndash;              >&ndash;&gt;
            </div>
          </template>
        </el-table-column>-->
        <!-- 空白页 -->
        <template #empty>
          <empty-common detail-text="暂无付款明细"></empty-common>
        </template>
      </el-table>
      <el-pagination
        v-if="total > 0"
