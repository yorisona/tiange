/**
 * 排班设置弹窗表单
 * @author  shiche <shiche@goumee.com>
 * @since   2021-01-12 15:45:00
 */
import {
  computed,
  defineComponent,
...
import { postSaveKol, getKolName, postSaveOperate } from '@/api/shop.project';
      ...
      data.kol_schedule_infos.forEach(el => {
        ...
        el.kol_ids =
          props.type === 'anchor'
            ...
            : data.oprateList.filter(op => ids.includes(op.username)).map(op => op.id);
