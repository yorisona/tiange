...
-->
<template>
  <div class="tg-live-project-team-member">
    <el-dialog
    ...
    >
      <div class="team-member-content">
        <el-form :model="form" label-width="60px" size="mini" label-position="top">
          <div class="manager-row">
            <el-form-item label="客户经理：">
              <el-select
                ...
                :remote-method="getAllCustomManagerRequest"
              >
                <el-option
                  v-for="(customerManager, cIndex) in customerManagers"
                  :key="cIndex"
                  :label="customerManager.username"
          ...
          <el-form-item label="其他成员：" style="margin-bottom: 0" />
          <el-select
            size="mini"
            popper-class="el-select-popper-mini"
            clearable
