...
import addProject from './dialog/addProject/index.vue';
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const resetQueryForm = () => {
      ...
      queryForm.value.business_type = -1;
    ...
    const reload = async (clean = true) => {
      ...
      queryData.not_business_types = '7';
    ...
    const Permission = computed(() => {
      const canViewList = HasPermission(RIGHT_CODE.live_project_view);
