      ...
      >
        ...
        <div class="grid-item-content-detail">
          <div v-if="day.status === 2" style="display: flex; flex-direction: column">
            <el-popover
              v-for="(live, liveIndex) in three_live(day)"
              :key="liveIndex + 'live'"
            ...
            >
              <div>
                <div
                  class="live"
                  :class="[
                    live.live_status === 4 ? 'archiving' : is_live_abnormal(live) ? 'abnormal' : '',
                    tipIndex > 0 ? 'mgt-12' : '',
                  ]"
              ...
              >
                <div v-if="liveIndex < 3">{{ live.time_str }}</div>
              </div>
            </el-popover>
          </div>
          <div
        ...
        <div
          ...
          v-if="day.status === 2 && day.shop_live_list.length > 3"
        >
          <el-popover
          ...
          >
            ...
            <div class="live-list">
              <template v-for="(live, liveIndex) in day.shop_live_list">
                <div
                  class="live"
                  v-if="liveIndex > 2"
                  :key="liveIndex + 'live'"
