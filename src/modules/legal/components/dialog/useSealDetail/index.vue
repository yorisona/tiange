<template>
  <div v-if="visible">
    <el-dialog
      ...
      @close="emitClose"
    >
      <template #title> <span>用印审批</span> </template>
        ...
        <div class="left-wrapper">
          ...
          <div class="left-body">
            <div class="grid-two-column">
              ...
              <div class="line" v-if="baseData.matter_type !== 3">
                <p class="label">盖章份数：</p>
                <div class="value">{{ baseData.file_number }}</div>
              </div>
              <!-- <div class="line" v-if="baseData.matter_type === 3 " style="height: auto">
            ...
            <div class="line" style="height: auto">
              <p class="label">扫描件：</p>
              <div class="value line-value">
                <template v-if="baseData.scan && baseData.scan.length">
                  <Appendix :list="baseData.scan" />
                </template>
                <span v-else>--</span>
              </div>
            </div>
      ...
      <template #footer>
        ...
        <!-- <tg-button type="primary" @click="emitClose">重新提交</tg-button> -->
      </template>
    </el-dialog>
  </div>
</template>
