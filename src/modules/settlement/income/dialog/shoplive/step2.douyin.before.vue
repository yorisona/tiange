        ...
        <el-form @submit.native.prevent :model="DataForm" size="mini" label-width="68px">
          <div class="commission-block">
            ...
            <div v-else style="padding: 0 18px">
              <!-- 青木6.13说要去除v-if="cooperation_type !== 2" -->
              <el-form-item label="服务费：" class="mgt-18" label-width="78px">
                <el-input
                  @input="ServiceAmountInput"
                  maxlength="12"
                  placeholder="请输入"
              ...
              <el-form-item
                ...
                label-width="78px"
                :class="cooperation_type === 2 ? 'mgt-18' : ''"
              >
                <el-input
              ...
              <el-form-item label="营销/商广：" label-width="78px">
                <el-input
              ...
              <el-form-item label="佣金：" label-width="78px">
...
<script src="./step2.douyin.before.ts"></script>
