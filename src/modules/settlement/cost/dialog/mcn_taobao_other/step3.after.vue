  ...
  >
    ...
    <template #left>
      <card-layout :padding="[0]">
        ...
        <div class="settlement-mcn-taobao-step3-detail" style="margin-top: 18px">
      ...
      <div class="upload-form">
        ...
        >
          ...
          <div
            ...
            :style="{ height: 28 * settlementFiles.length + 'px' }"
            v-else
          >
            <div
        ...
        >
          ...
          >
            ...
            <div v-if="readonly">
              <div style="color: var(--text-color); width: 600px; font-size: 12px">
...
<script src="./step3.after.tsx"></script>
<style lang="less">
@import '~@/styles/utils/index.less';
.tg-cost-mcn-taobao-step3-after-container {
  width: 1100px;
  &.readonly {
...
.settlement-mcn-taobao-step3-detail {
  padding: 0 10px;
  .empty {
    display: flex;
...
/deep/.tg-btn.tg-btn-default {
  border-color: rgba(164, 178, 194, 0.5);
}
/deep/.el-form {
  .el-form-item__label {
    // height: 32px;
