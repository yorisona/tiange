...
export default defineComponent({
  ...
  render() {
    return (
      <div class="investment-unite">
        <tg-card padding={[16, 16, 4, 16]} class="investment-unite-filter">
          <el-form
            class="flex-form"
            inline={true}
            size="mini"
        ...
        <tg-card class="mgt-10 investment-unite-table">
        ...
        <create-dialog
          ...
          is_estimate="1"
          onSuccess={(unite: any) => {
            this.detailDialogRef?.show(unite, false);
            this.createHandler();
          }}
        />
        <detail-dialog
