...
import keyInfo from './dialog/keyInfo/index.vue';
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    let project_id: string | undefined = router.currentRoute.query?.project_id as string;
      ...
      <div class="tg-manager-project-management-dashboard-container">
        <section class="query-field">
          <div class="query-item">
            ...
            <department-select
              // levelDisabled={(level: number) => level >= 4}
          ...
          <div class="query-item">
            ...
            <el-select
              ...
              filterable
              remote
              remote-method={this.queryProjectList}
              loading={this.reqProjectList.loading}
            >
              {this.reqProjectList.data?.map(el => (
                <el-option label={el.project_name} value={el.id} key={el}></el-option>
              ))}
              {/* {this.projectTypeOption.map((el, index) => {
                return <el-option label={el.label} value={el.value} key={index + 1}></el-option>;
              })} */}
          ...
          <div class="query-item">
            ...
            <tg-button class="el-btn-mini" onClick={this.reset}>
              重置
            </tg-button>
          </div>
        </section>
