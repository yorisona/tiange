...
<template>
  <div class="table-main">
    <tg-card :padding="[18]" @rect:update="onTopCardRectUpdate">
      <!-- <el-input
        size="medium"
      ...
      <el-form :inline="true" ref="formRef" label-width="60px" size="mini" label-position="left">
        ...
        <el-form-item style="margin-left: 24px" label="二级类目">
          <el-select
            style="width: 264px"
            placeholder="请选择类目"
            v-model="select_cat_id"
        ...
        <el-form-item style="margin-left: 24px" label="三级类目">
          <el-select
            style="width: 264px"
            placeholder="请选择类目"
    ...
    <tg-card
      class="mgt-12 flex-auto live-display-content"
      :padding="[18, 18, 0, 18]"
...
<script src="./projectShopDetail.ts"></script>
