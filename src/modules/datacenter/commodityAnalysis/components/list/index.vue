<!--
 * @Author: 肖槿
 * @Date: 2022-02-17 14:50:32
 * @Description:
 * @LastEditors: Please set LastEditors
 * @LastEditTime: 2022-05-23 11:45:40
 * @FilePath: \goumee-star-frontend\src\modules\datacenter\commodityAnalysis\components\list\index.vue
-->
<template>
  <div class="commodity-analysis-system">
    <div class="first-category-box">
      ...
      <tg-button
        type="default"
        icon="ico-btn-export"
        style="margin-top: 16px; border-color: var(--border-line-color)"
    ...
    <div class="category-table">
      ...
      >
        ...
        >
          <template slot="header" slot-scope="scope"
            ...
            <el-popover
              placement="top"
              trigger="hover"
              :content="`${scope.column.label.replace(
                '环比',
                '',
              )}上个自然周与上上个自然周的对比增幅`"
            >
              <tg-icon slot="reference" name="ico-question" style="color: #939393" />
            </el-popover>
          </template>
          <template slot-scope="scope">
            <tg-icon
              v-if="scope.row.shop_sale_count_rate !== null"
              :name="
                scope.row.shop_sale_count_rate >= 0
                  ? 'ico-icon_tongyong_shangsheng_16_red'
                  : 'ico-icon_tongyong_xiajiang_16_green'
              "
            />
            {{
              scope.row.shop_sale_count_rate !== null
                ? numberFormat(Math.abs(Number(scope.row.shop_sale_count_rate)), 2) + '%'
                : '--'
            }}
          </template>
        </el-table-column>
        ...
        >
          ...
          <template slot-scope="scope">
            <tg-icon
              v-if="scope.row.shop_sale_gmv_rate !== null"
              :name="
                scope.row.shop_sale_gmv_rate >= 0
                  ? 'ico-icon_tongyong_shangsheng_16_red'
                  : 'ico-icon_tongyong_xiajiang_16_green'
              "
            />
            {{
              scope.row.shop_sale_gmv_rate !== null
                ? numberFormat(Math.abs(Number(scope.row.shop_sale_gmv_rate)), 2) + '%'
                : '--'
            }}
          </template>
        </el-table-column>
        ...
        >
          <template slot="header" slot-scope="scope">
            ...
            <el-popover
              placement="top"
              trigger="hover"
              :content="`上个自然周和上上个自然周的平均件单价对比增幅`"
            >
              <tg-icon slot="reference" name="ico-question" style="color: #939393" />
            </el-popover>
          </template>
          <template slot-scope="scope">
            <tg-icon
              v-if="
                scope.row.shop_sale_price_avg_rate !== null &&
                scope.row.shop_sale_price_avg_rate !== undefined
              "
              :name="
                scope.row.shop_sale_price_avg_rate >= 0
                  ? 'ico-icon_tongyong_shangsheng_16_red'
                  : 'ico-icon_tongyong_xiajiang_16_green'
              "
            />
            {{
              scope.row.shop_sale_price_avg_rate !== null &&
              scope.row.shop_sale_price_avg_rate !== undefined
                ? numberFormat(Math.abs(Number(scope.row.shop_sale_price_avg_rate)), 2) + '%'
                : '--'
            }}
          </template>
        </el-table-column> -->
        ...
        >
          ...
          <template slot-scope="scope">
            <tg-icon
              v-if="scope.row.sale_count_rate !== null"
              :name="
                scope.row.sale_count_rate >= 0
                  ? 'ico-icon_tongyong_shangsheng_16_red'
                  : 'ico-icon_tongyong_xiajiang_16_green'
              "
            />
            {{
              scope.row.sale_count_rate !== null
                ? numberFormat(Math.abs(Number(scope.row.sale_count_rate)), 2) + '%'
                : '--'
            }}
          </template>
        </el-table-column>
        ...
        >
          ...
          <template slot-scope="scope">
            <tg-icon
              v-if="scope.row.sale_gmv_rate !== null"
              :name="
                scope.row.sale_gmv_rate >= 0
                  ? 'ico-icon_tongyong_shangsheng_16_red'
                  : 'ico-icon_tongyong_xiajiang_16_green'
              "
            />
            {{
              scope.row.sale_gmv_rate !== null
                ? numberFormat(Math.abs(Number(scope.row.sale_gmv_rate)), 2) + '%'
                : '--'
            }}
          </template>
        </el-table-column> -->
