...
(function () {
  ...
  const Symbol = root.Symbol,
    symToStringTag = Symbol ? Symbol.toStringTag : undef;
  ...
  function baseGetTag(value) {
    if (value == null) {
      return value === undef ? undefinedTag : nullTag;
    }
  ...
  function debounce(func, wait, options) {
    ...
    function cancel() {
      ...
      lastInvokeTime = 0;
      lastArgs = lastCallTime = lastThis = timerId = undef;
    }

    function flush() {
      return timerId === undef ? result : trailingEdge(now());
    }
