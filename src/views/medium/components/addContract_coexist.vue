      ...
      <div class="box1">
        ...
        <div class="content-body">
          <div class="content-lines">
            <div class="content-label">是否补充协议：</div>
            ...
            <div class="content-value">
              <template>
                ...
                <el-upload
                  ...
                  :multiple="false"
                  accept=".pdf,.docx,.doc,.jpg,.png,.jpeg,.xlsx"
        ...
        <div class="content-body">
          <div class="line-status" v-for="(items, j) in proceeds_plan" :key="j">
            <div>
              ...
              ><el-input placeholder="0.00" v-model="items.proceeds_amount" size="small"></el-input>
            </div>
            <div>
              <span class="body_label">已付金额：</span
              ><el-input placeholder="0.00" v-model="items.obtained_amount" size="small"></el-input>
            </div>
            <div>
            ...
            <div>
              ...
              ><el-input placeholder="0.00" v-model="items.invoice_amount" size="small"></el-input>
            </div>
            <div>
...
export default {
  ...
  methods: {
      ...
      Promise.resolve()
        ...
        .then(res => {
          if (res.data.success) {
            ...
            if (this.type === 'edit') {
              this.$emit('edited');
              location.href = window.location.href.split('=')[0] + `=${this.form.contract_type}`;
            }
    ...
    async getContractNumber() {
      Promise.resolve()
        .then(() => {
          if (this.breadcrumb.isLiveDetail || this.breadcrumb.isCommonBusinessDetail) {
